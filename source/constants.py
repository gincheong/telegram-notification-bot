...
class Message :
  ...
  WARN = "데이터는 암호화 없이 저장됩니다.\n" + \
         "또한 오류 발생 시 디버그 목적으로 로그를 기록하고 있습니다.\n" + \
         "키워드 추가, 삭제나 키워드 알림 등의 DB 작업이 있을 시에 그 내용들도 같이 로그에 작성합니다.\n" + \
         "이 점 확인하시고 사용 부탁드리며, 저는 로그 내용을 악용할 생각이 없습니다.\n" + \
         "데이터베이스에서 본인의 정보를 모두 삭제하고 싶으신 분은 /info 명령어를 통해 제 이메일이나 텔레그램으로 연락주시면 됩니다."